export default function Footer() {
    return (
        <footer className="px-4 sm:px-6 md:px-10 lg:px-20">
            ...
            <div className="container">
                <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:gap-20 text-center lg:text-left">
                    ...
                    <div className="w-full max-w-[400px]">
                        <form className="flex flex-col items-start lg:items-start w-full">
                            <label className="!mt-0" htmlFor="Name">Name</label>
                            <input className="body--text w-full p-2 rounded-md" type="text" name="Name" placeholder="John Doe" />

                            <label htmlFor="Email">Email</label>
                            <input className="body--text w-full p-2 rounded-md" type="email" name="Email" placeholder="example@gmail.com" />
